...
def delete_old_records():
    ...
    # Calcular la fecha de corte (dos días atrás desde la fecha actual)
    two_days_ago = datetime.now() - timedelta(days=2)
    
    # Borrar los registros que sean más antiguos que dos días
    cursor.execute('''
    DELETE FROM can_data WHERE timestamp < ?
    ...
    print(f"Registros anteriores a {two_days_ago.isoformat()} eliminados.")
