...
def save_to_mongo(can_id, sensor_name, timestamp, value):
    ...
    document = {
        ...
        "timestamp": timestamp,  # Guardar directamente el objeto datetime
        "value": value
    }
        ...
        while True:
            ...
            if message:
                ...
                if len(message.data) == 8:
                    ...
                    # Convertir el timestamp de epoch a un objeto datetime con zona horaria
                    timezone = pytz.timezone('America/Montevideo')  # Cambiar a la zona horaria adecuada
                    timestamp = datetime.fromtimestamp(timestamp, timezone)
